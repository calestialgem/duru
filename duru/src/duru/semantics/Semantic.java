...
public sealed interface Semantic {
  ...
  String standardPackage = "duru";

  /** Collective understanding of a piece of code. */
  record Project(Map<Namespace, Package> packages) implements Semantic {
    /** Constructs. */
    public Project {
  ...
  sealed interface Known extends Expression {
    @Override
    default Set<Name> dependencies() {
      return Set.of();
    }
  ...
  /** Expression that evaluates to a hard-coded unsigned integral value. */
  record KnownNatural(long value) implements Known {
    @Override
    public String toString() {
      return "KnownNatural[value=%s]".formatted(Long.toUnsignedString(value));
    }
  }

  /** Expression that evaluates to a hard-coded floating-point value. */
  record KnownReal(double value) implements Known {
    @Override
    public String toString() {
      return "KnownReal[value=%s]"
        .formatted(FloatingPointFormatter.format(value));
    }
  }
  ...
  record KnownString(String value) implements Known {
    @Override
    public String toString() {
      return "KnownString[value=\"%s\"]".formatted(value);
    }
  }
