...
public sealed interface Token {
  ...
  record Entrypoint(int start) implements Token {
    @Override
    public int end() {
      return start + "entrypoint".length();
    }
  ...
  record NaturalConstant(int start, int end, long value) implements Token {
    @Override
    public String explanation() {
      return "natural `%s`".formatted(Long.toUnsignedString(value));
    }

    @Override
    public String toString() {
      return "NaturalConstant[start=%d, end=%d, value=%s]"
        .formatted(start, end, Long.toUnsignedString(value));
    }
  }

  /** A floating-point constant. */
  record RealConstant(int start, int end, double value) implements Token {
    @Override
    public String explanation() {
      return "real `%s`".formatted(FloatingPointFormatter.format(value));
    }

    @Override
    public String toString() {
      return "RealConstant[start=%d, end=%d, value=%s]"
